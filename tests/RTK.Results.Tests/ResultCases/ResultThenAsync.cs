...
{
    public class ResultThenAsync
    {
        [Fact]
        public async Task Create_Result_ThenAsync_Next()
        {
            var message = "test";
        ...
        [Fact]
        public async Task Create_Result_ThenAsync_On_Error()
        {
        ...
        [Fact]
        public async Task Create_Resut_ThenAsync_Next_Result()
        {
            var message = "test";
            //var failMessage = "TEST";
            //var error = Error.Create("fail", $"Message {message} is not equal {failMessage}");
            ...
            var result = await message.ToResult()
                .AsTask()
                .ThenAsync(r => Task.FromResult(r.Length.ToResult()))
                ;
        ...
        [Fact]
        public async Task Create_Resut_ThenAsync_Next_Result_On_Error()
        {
            var error = Error.Create("fail", $"Error");
            var expectedValue = 4;
